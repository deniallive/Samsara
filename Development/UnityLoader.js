...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Samsara.data';
    var REMOTE_PACKAGE_BASE = 'Samsara.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3995945;
      var PACKAGE_UUID = '51b2e93e-f30d-4348-baca-5b2f61b2eae8';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 1211350, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(1211350, 1212648, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1212648, 1216060, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(1216060, 3093348, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3093348, 3968320, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3968320, 3995945, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Samsara.data');

    };
    Module['addRunDependency']('datafile_Samsara.data');
