...
public abstract class Unit : MonoBehaviour
{
    ...
    public virtual void DealDamage(Unit other)
    {
        ...
        if (this.type == 1)
        {
            other.Defend(this, AttackFactor, this.type);
        }
        ...
        {
            other.Defend(this, MagicDamage, this.type);
        }
    ...
    /// </summary>
    protected virtual void Defend(Unit other, int damage,int type)
    {
        ...
        {
            HitPoints -= Mathf.Clamp(damage - MagicDefence, 1, damage);
        }
